...
import DoctorInbox from "../components/chat/DoctotInbox"; // Import the Inbox component
import { acceptAppointment } from "../services/doctorService";
...
const DoctorDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState("appointments"); // Track the active tab
  ...
  }, [activeTab]); // Fetch appointments when the active tab is 'appointments'
...
>
  Accept
        ...
        {activeTab === "inbox" && <   DoctorInbox  appointmentChat={appointmentData}  />} {/* Render the Inbox component when tab is 'inbox' */}

        {activeTab === "home" && <h2>Welcome to the Doctor Dashboard</h2>}
      </main>
    </div>
  );
};
